...
const AREA_SCENE: Record<string, string> = {
  ...
  umeda:
    "梅田はJR・地下鉄・阪急・阪神が交差する関西最大のターミナルで、お初天神・HEP FIVE・駅前地下街の飲食店が徒歩圏にまとまっています。",
  hakata:
    "博多はJR博多駅を中心に、博多めん系ラーメン・もつ鍋など地場飲食と駅ビル内チェーンが揃う九州遠征の拠点です。",
  tenjin:
    "天神は西鉄福岡（天神）駅周辺の繁華街で、百貨店・地下街と連動した飲食店が密集するエリアです。",
  sakae:
    "栄は地下鉄栄駅を中心に、若宮大通り・プリンセス大通り周辺の飲食激戦区とキング観光サウザンドの大型店が揃う名古屋の中心繁華街です。",
  "nagoya-ekimae":
    "名古屋駅はJR・名鉄・近鉄が交差する中部最大のターミナルで、駅ビル・地下街と柳橋周辺の飲食店が徒歩圏にまとまっています。",
  sendai:
    "仙台は東北新幹線・JR仙台駅を中心に、名掛丁商店街と駅東口周辺の飲食店が徒歩圏にまとまる東北の代表拠点です。",
  "sapporo-ekimae":
    "札幌駅前はJR札幌駅・地下鉄さっぽろ駅周辺に、味噌ラーメンやスープカレーなど北海道らしい飲食店と駅前チェーンが揃う繁華街です。",
  tanukikoji:
    "狸小路は大通・すすきのを結ぶ商店街で、味噌ラーメンやジンギスカンなど地場飯と回転の速いチェーンが密集しています。",
}
